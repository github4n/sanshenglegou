...
public class WeixinConfig {
   ...
   public  static final  String API_KEY = "CErjCXMqdC5nXoYRIWI1YDz8B4UUv65m";
    public  static  final  String KeyPath="/www/backend/apiclient_cert.p12";
    public  static  final String notifyUrl="http://www.shunnonghui.com/payresult/result/";
     public  static final String BAIDULation="3vmb6zina9IM6ku0mkMONj8ge62Gj030";
}
